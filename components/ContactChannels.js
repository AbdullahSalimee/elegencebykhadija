...
// The stateful half of /contact — the message box and the channel cards, which
// share the pre-filled WhatsApp link built from what's typed above. Split out of
// the page so the page can stay a Server Component and render Nav and Footer.
